...
void* qthread(void* arg){
    struct qarg argumento = *(struct qarg*)arg;
    qsort(argumento.a,argumento.n);
}
...
void qsort(int a[], int N){
    ...
    pthread_create(&t1,NULL,qthread,(void*)&argumento1);
    pthread_create(&t2,NULL,qthread,(void*)&argumento2);
